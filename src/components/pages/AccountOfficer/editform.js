  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://taalib-superadmin-api.onrender.com/api/accountOfficer/update/${searchString}`,
        accOfficer,
        {
      ...
      setEmail("");
      setPassword("");
      navigate("/ManageAccOfficer/EditAccOfficer/AccOffInfo");
    } catch (error) {
      alert(error);
    }
  };
